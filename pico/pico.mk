...
PRODUCT_COPY_FILES += \
    ...
    device/htc/pico/files/etc/firmware/fw_bcm4330.bin:system/etc/firmware/fw_bcm4330.bin \
    device/htc/pico/files/etc/firmware/fw_bcm4330_apsta.bin:system/etc/firmware/fw_bcm4330_apsta.bin \
    device/htc/pico/files/etc/firmware/fw_bcm4330b2.bin:system/etc/firmware/fw_bcm4330b2.bin \
    device/htc/pico/files/etc/firmware/fw_bcm4330b2_apsta.bin:system/etc/firmware/fw_bcm4330b2_apsta.bin \
...
PRODUCT_COPY_FILES += \
   ...
   # vendor/htc/pico/proprietary/lib/libaudioeq.so:system/lib/libaudioeq.so \
    vendor/htc/pico/proprietary/lib/libaudiopolicy.so:system/lib/libaudiopolicy.so \
   # vendor/htc/pico/proprietary/lib/libaudioflinger.so:system/lib/libaudioflinger.so \
   # vendor/htc/pico/proprietary/lib/libaudioeffect_jni.so:system/lib/libaudioeffect_jni.so \
    vendor/htc/pico/proprietary/lib/libmedia.so:system/lib/libmedia.so \
    vendor/htc/pico/proprietary/lib/libsrsprocessing.so:system/lib/libsrsprocessing.so \
    vendor/htc/pico/proprietary/lib/soundfx/libsrsfx.so:system/lib/soundfx/libsrsfx.so \
    vendor/htc/pico/proprietary/lib/libhtcbitmapfactory.so:system/lib/libhtcbitmapfactory.so \
    ...
    device/htc/pico/files/etc/AudioBTID.csv:system/etc/AudioBTID.csv \
    device/htc/pico/files/etc/AudioPara4.csv:system/etc/AudioPara4.csv \
    device/htc/pico/files/etc/AudioPara4_WB.csv:system/etc/AudioPara4_WB.csv \
    device/htc/pico/files/etc/AudioPreProcess.csv:system/etc/AudioPreProcess.csv \
